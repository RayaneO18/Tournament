...
export const initialQuarts: Match[] = [
  ...
  { eq1: "France", score1: 2, tab1: null, eq2: "Argentine", score2: 3, tab2: null, poule: "Quart de finale", date: "12 Juin" },
];
...
export const initialFinale: Match = { eq1: "", score1: 0, tab1: 0, eq2: "", score2: 0, tab2: 1, poule: "Finale", date: "2 juillet" };
...
export const initialMatchsSpeciaux: Match[] = [
  ...
  { eq1: "Algérie", score1: 0, tab1: null, eq2: "Portugal", score2: 1, tab2: null, poule: "Spécial", date: "29 juin", label: "COUPE DU FAIR-PLAY" },
  { eq1: "Parents", score1: null, tab1: null, eq2: "Animateurs", score2: null, tab2: null, poule: "Spécial", date: "annulé", label: "MATCH RETOUR ANIMATEURS VS PARENTS" }
];
